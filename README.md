...
- False accept: в расчётах assumption ≈200 000 ₽ за подтверждённый инцидент (расклад в [docs/product.md](docs/product.md)); при FA — стоп авто-открытия. В базовом net считаю 0 таких случаев.
